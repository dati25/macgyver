...
- The `rossum-sa` plugin has 6 invocable skills (analyze, document, implement, refine-deployment, upgrade, write-sow) and 10 autoloaded reference packs (*-reference skills)
